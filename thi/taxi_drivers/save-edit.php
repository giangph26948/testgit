...
if(!empty($nameerr) || !empty($company_iderr) || !empty($taxi_plateerr) || !empty($joined_dateerr) || !empty($salaryerr) || !empty($created_aterr) || !empty($updated_aterr)){
    header("location: edit.php?id=$id&nameerr=$nameerr&company_iderr=$company_iderr&taxi_plateerr=$taxi_plateerr&joined_dateerr=$joined_dateerr&salaryerr=$salaryerr&created_aterr=$created_aterr&updated_aterr=$updated_aterr");
    die;
}
...
$sqlQuery = "UPDATE taxi_drivers SET
name='$name',
